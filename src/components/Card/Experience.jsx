        ...
        <section class="card-list items-center justify-center ">
          ...
          <article class="card">
            <header class="card-header">
              ...
              <p className="text-left">
                - Created a restaurant management system website for an Australian client.
                - Implemented payment gateway integration and designed UI/UX with Figma.
              </p>
            </header>
          ...
          <article class="card">
            ...
            <a class="author-avatar" >
              ...
              <div class="author-name">
                <div class="author-name-prefix text-white">Backend Software Engineer intern</div>
                Bobble Ai
              </div>
            </div>
          </article>
